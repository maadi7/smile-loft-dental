    ...
    <div className="bg-bgtop flex h-full w-full items-center justify-center py-16 px-24 !overflow-hidden">
      <div className="grid h-full w-full gap-8 p-2 grid-cols-4 grid-rows-4">
        ...
        >
          ...
          <p className='text-2xl font-nunito max-w-[600px] text-primary mb-10'>
            Creating confident smiles with personalized dental care and advanced treatments for a healthier, brighter you!
          </p>
          <Link href="/our-services">
            <button className='px-8 py-3 text-xl font-nunito text-[#F7F6F3] bg-primary rounded-lg shadow-lg'>
              SEE MORE
            </button>
          </Link>
        </motion.div>
        ...
        >
          <Link href={"/our-services/teeth-whitening"}>
            <h3 className='text-4xl font-playfair mb-4 -mt-10 text-center text-primary'>
              Teeth <br />
              Whitening
            </h3>
          </Link>
        ...
        <motion.div
          className="col-span-1 row-span-2 p-4 bg-box1 rounded-lg flex flex-col text-center items-center justify-center"
        ...
        >
          <Link href={"/our-services/dental-implants"}>
            <h3 className='text-4xl font-playfair text-center mb-4 text-primary'>
              Dental <br />
              Implants
            </h3>
          </Link>
        ...
        <motion.div
          className="col-span-1 row-span-2 p-4 bg-box2 rounded-lg text-center flex flex-col items-center justify-center"
          variants={fadeIn("right", "tween", 0.2, 1)}
          initial="hidden"
          whileInView="show"
          viewport={{ once: true }}
        ...
        >
          <Link href={"/our-services/dental-crowns"}>
            <h3 className='text-4xl font-playfair mb-4 text-primary'>
              Dental <br />
              Crowns
            </h3>
          </Link>
        ...
        >
          <Image src={servicesImage} alt='Our services' className='h-full' />
        </motion.div>
      </div>
    </div>
  );
