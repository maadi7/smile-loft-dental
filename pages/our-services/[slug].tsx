...
<div className="mb-4 w-full">
  ...
  <div className='flex flex-col items-start mr-0 lg:mr-10 mb-8 lg:mb-0'>
    ...
    <h1 className='text-4xl sm:text-[56px] font-playfair font-semibold mb-3 sm:mb-5 text-primary uppercase'>{service.name}</h1>
    <p className='text-xl sm:text-2xl font-nunito max-w-[590px] text-primary !leading-8 sm:!leading-10'>{service.description}</p>
  </div>
  <div>
    <Image 
      src={serviceImage} 
